...
def DeeplabV2(input_shape, upsampling=8, apply_softmax=True,
    ...
    b1 = Lambda(resize_bilinear, name='resize_1')(b1)
    b2 = Lambda(resize_bilinear, name='resize_2')(b2)
    b3 = Lambda(resize_bilinear, name='resize_3')(b3)
    b4 = Lambda(resize_bilinear, name='resize_4')(b4)

    m = Add(name='merge_labels')([b1, b2, b3, b4])

    x = Reshape((nb_rows * nb_cols, classes))(m)
    x = Activation('softmax')(x)
    out = Reshape((nb_rows, nb_cols, classes))(x)
